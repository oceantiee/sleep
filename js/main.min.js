...
function stickyHeader(){let e,t=document.querySelector(".header");{function r(){if(30<pageYOffset)t.classList.add("header--sticky");else{t.classList.remove("header--sticky");let e=document.querySelector(".user-nav--active");e&&e.classList.remove("user-nav--active")}e=pageYOffset}t}r(),window.addEventListener("scroll",r)}function stickyPlayer(){let e=document.querySelector(".player");function t(){document.documentElement.offsetHeight<=window.innerHeight+pageYOffset?e.classList.add("player--transparent"):e.classList.remove("player--transparent")}t(),window.addEventListener("scroll",t)}function mobileMenu(){let e=document.querySelector(".user-nav__button"),t=e.closest(".user-nav");e.addEventListener("click",function(){t.classList.toggle("user-nav--active")})}function userMenu(){let e=document.querySelectorAll(".user-profile__nav");e.forEach(e=>{e.addEventListener("click",function(){e.classList.toggle("user-profile__nav--active")})})}function activeCard(){let e=document.querySelectorAll(".card");0<e.length&&e.forEach(t=>{let e=t.querySelector(".card__media");e.addEventListener("click",function(){if(t.classList.contains("card--active"))t.classList.remove("card--active");else{let e=document.querySelector(".card--active");e&&e.classList.remove("card--active"),t.classList.add("card--active")}})})}function rangeInputProgress(){let e=document.querySelectorAll('input[type="range"]');e.forEach(r=>{function e(){var e=r.value/r.max*100,t=getComputedStyle(document.documentElement).getPropertyValue("--accent");r.style.backgroundImage=`linear-gradient(to right, ${t} ${e}%, transparent ${e}%)`}e(),r.addEventListener("input",e)})}function volumeVisual(){let e=document.querySelectorAll('.player__sound input[type="range"]');0<e.length&&e.forEach(e=>{let t=e.closest(".player__sound");function r(){70<Number(e.value)?t.classList.add("loud"):t.classList.remove("loud"),0==Number(e.value)?t.classList.add("mute"):t.classList.remove("mute")}r(),e.addEventListener("input",r)})}function playButton(){let t=document.querySelectorAll(".player__play");t.forEach(e=>{e.addEventListener("click",function(){t.forEach(e=>{e.classList.toggle("player__play--pause")})})})}function playerHeight(){let t=document.querySelector(".player__top"),r=document.querySelector(".player__box"),a=document.querySelector(".player__cover");function e(){var e=document.documentElement.clientHeight-(t.offsetHeight+r.offsetHeight+50);e<0?(newWidth=a.offsetWidth+e,a.style.maxWidth=newWidth+"px"):a.offsetWidth<=500&&(a.style.maxWidth=a.offsetWidth+e+"px")}e(),window.addEventListener("resize",e)}function playerOverlayColor(){let t=document.querySelector(".player__cover img"),r=document.querySelector(".player__overlay");function e(){var e=function(e){var t,r,a,o={r:0,g:0,b:0},l=document.createElement("canvas"),n=l.getContext&&l.getContext("2d"),i=-4,s={r:0,g:0,b:0},c=0;if(!n)return o;r=l.height=e.naturalHeight||e.offsetHeight||e.height,l=l.width=e.naturalWidth||e.offsetWidth||e.width,n.drawImage(e,0,0);try{t=n.getImageData(0,0,l,r)}catch(e){return alert("x"),o}for(a=t.data.length;(i+=20)<a;)++c,s.r+=t.data[i],s.g+=t.data[i+1],s.b+=t.data[i+2];return s.r=~~(s.r/c),s.g=~~(s.g/c),s.b=~~(s.b/c),s}(t);r.style.backgroundColor="rgb("+e.r+","+e.g+","+e.b+")"}t.complete?e():t.addEventListener("load",function(){e()})}function playerAnimation(){let t=document.querySelector("body"),r=document.querySelector(".player"),a=document.querySelector(".player__preview");document.querySelector(".player__cover");let o=document.querySelector(".player__track .player__title"),l=document.querySelector(".player__box .player__title"),n=document.querySelector(".player__track .player__artist"),i=document.querySelector(".player__box .player__artist"),s=(gsap.registerPlugin(Flip),gsap.registerPlugin(CustomEase),CustomEase.create("customEase",".25,.1,.25,.1"),.35),c="customEase";function e(){t.classList.add("lock"),gsap.set(".player__overlay",{opacity:1}),gsap.to(".player__overlay",{top:0,duration:s,ease:"sine.out"});var e=Flip.getState(".player__cover, .player__preview",{props:"borderRadius"}),e=(gsap.to(a,{duration:.175,ease:c,xPercent:25,onComplete:function(){gsap.to(a,{duration:.175,ease:c,xPercent:0,onComplete:function(){gsap.set(a,{clearProps:"transform"})}})}}),Flip.to(e,{duration:s,absolute:!0,ease:c,zIndex:5,onStart:function(){r.classList.add("animating")},onComplete:function(){a.removeAttribute("style"),r.classList.add("player--open"),r.classList.remove("animating")}}),Flip.getState(".player__box .player__title, .player__track .player__title",{props:"color, fontSize"})),e=(Flip.to(e,{duration:s,absolute:!0,ease:c,onComplete:function(){o.removeAttribute("style"),l.removeAttribute("style")}}),Flip.getState(".player__box .player__artist, .player__track .player__artist",{props:"color, fontSize"}));Flip.to(e,{duration:s,absolute:!0,ease:c,onComplete:function(){n.removeAttribute("style"),i.removeAttribute("style")}})}function u(){t.classList.remove("lock"),r.classList.remove("player--open"),gsap.to(".player__overlay",{top:"calc(100vh - 81px)",duration:s-.07,ease:"sine.in",onComplete:function(){gsap.to(".player__overlay",{opacity:0,duration:.05})}});var e=Flip.getState(".player__cover, .player__preview",{props:"borderRadius"}),e=(Flip.from(e,{duration:.3,absolute:!0,ease:c,zIndex:5,onStart:function(){r.classList.add("animating")},onComplete:function(){a.removeAttribute("style"),r.classList.remove("animating")}}),Flip.getState(".player__box .player__title, .player__track .player__title",{props:"color, fontSize"})),e=(Flip.from(e,{duration:s,absolute:!0,ease:c,onComplete:function(){o.removeAttribute("style"),l.removeAttribute("style")}}),Flip.getState(".player__box .player__artist, .player__track .player__artist",{props:"color, fontSize"}));Flip.from(e,{duration:s,absolute:!0,ease:c,onComplete:function(){n.removeAttribute("style"),i.removeAttribute("style")}})}document.querySelector(".player__track").addEventListener("click",e),document.querySelector(".player__close").addEventListener("click",u),document.querySelector(".player__full").addEventListener("click",function(){(r.classList.contains("player--open")?u:e)()})}function popupOpen(){let e=document.querySelectorAll("a");e.forEach(e=>{var t=e.getAttribute("href").slice(1);if(document.getElementById(t)){let r=document.getElementById(t);e.addEventListener("click",function(e){let t=document.querySelector(".popup.active");t&&t.classList.remove("active"),r.classList.add("active"),document.querySelector("body").classList.add("overlay")})}})}function popupClose(){let e=document.querySelectorAll(".popup__close");e.forEach(e=>{e.addEventListener("click",function(){e.closest(".popup").classList.remove("active"),document.querySelector("body").classList.remove("overlay")})})}function initSliders(){let r=document.querySelector(".featured-cards__slider");if(r){function e(){let e=document.querySelector(".featured-cards__slider .swiper-slide-active"),t=e.style.transform;var r=t.match(/calc\(([^)]+)\)/g),a=t.match(/rotateX\(([^)]+)\)/),o=t.match(/rotateY\(([^)]+)\)/),l=t.match(/rotateZ\(([^)]+)\)/),n=t.match(/scale\(([^)]+)\)/),r=`translate3d(${r[0]}, ${r[1]}, 1px) rotateX(${a[1]}) rotateY(${o[1]}) rotateZ(${l[1]}) scale(${n[1]})`;e.style.transform=r}const o={slidesPerView:"auto",centeredSlides:!0,loop:!0,loopedSlides:3,effect:"creative",creativeEffect:{limitProgress:3,perspective:!0,progressMultiplier:1,next:{translate:["60.5%",-18,-200]},prev:{translate:["-60.5%",-18,-200]}},navigation:{prevEl:".featured-cards__slider .arrows__item--prev",nextEl:".featured-cards__slider .arrows__item--next"},on:{update:e,resize:e,slideChangeTransitionEnd:e}},l={slidesPerView:"auto",spaceBetween:16,slidesOffsetAfter:20,breakpoints:{768:{slidesOffsetAfter:24}}};let t=new Swiper(r,{init:!1});function a(e=!0){1!=e&&t.destroy(),t=1023<window.innerWidth?new Swiper(r,o):new Swiper(r,l)}a(),window.matchMedia("(max-width: 1023px)").addEventListener("change",function(){a(!1)})}let t=document.querySelectorAll(".slider-section");0<t.length&&t.forEach(e=>{var t=e.querySelector(".slider-section__main"),r=e.querySelector(".arrows__item--prev"),a=e.querySelector(".arrows__item--next");let o=e.querySelector(".slider-section__wrap");function l(){return-1*(window.innerWidth/-2+o.offsetWidth/2)}let n=new Swiper(t,{slidesPerView:"auto",slidesOffsetBefore:l(),slidesOffsetAfter:l(),navigation:{prevEl:r,nextEl:a},breakpoints:{1024:{}}});window.addEventListener("resize",function(){n.params.slidesOffsetBefore=l(),n.params.slidesOffsetAfter=l()})})}document.addEventListener("DOMContentLoaded",function(e){stickyHeader(),stickyPlayer(),mobileMenu(),userMenu(),activeCard(),rangeInputProgress(),volumeVisual(),playButton(),playerHeight(),playerOverlayColor(),playerAnimation(),popupOpen(),popupClose(),initSliders()});